...
Please review the [documentation](https://github.com/TAIMOOR) for guidelines and information about the software.

## Installation

-   Note: An in-depth guide is available on our [Wiki's Getting Started page](https://github.com/TAIMOOR). A condensed version is as follows:
...
```
git clone git@github.com:TAIMOOR
```
...
For development purposes, you can run the application locally by following the [Installation](https://github.com.TAIMOOR) Instructions.
...
If you encounter any issues regarding this project, please create a [Github Issue](https://github.com/TAIMOOR) using the relevant template. You can also tag a specific contributor if you feel like they might be able to help you out.

## Roadmap

Outstanding issues and requests can be tracked and visualised on our Github Projects page.

[Backend](https://github.com/TAIMOOR/projects/2)

[Frontend](https://github.com/TAIMOOR/projects/1)

[DevOps](https://github.com/TAIMOOR/projects/4)

[Documentation](https://github.com/TAIMOOR/projects/3)

## Contributing

If you would like to contribute to this project, please make sure to follow our [Contributing Guidelines](https://github.com/TAIMOOR/wiki/Contributing-Guidelines).
...
Please ensure all [code of conduct](https://github.com/TAIMOOR/wiki/Code-of-Conduct) is followed.
